...
const manualUpdates: ChangelogEntry[] = [
  ...
  },
  {
    ...
    title: "PWA Sidebar Updates and Navigation Refactoring",
    description: "",
    changes: [
      "PWA sidebar updates and visual alignment",
  ...
  },
  {
    ...
    title: "Add waste management project ideas and metadata generation",
    description: "",
    changes: [
      ...
      "Dynamic metadata generation for content entries",
  ...
  },
  {
    ...
    changes: [
      ...
      "Initialized repository for project Engineering workspace template",
    ],
    type: "start",
  },
];
