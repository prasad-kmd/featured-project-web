...
const title = `Portfolio | ${siteConfig.author}`;
const description =
  `Showcasing the professional journey, technical expertise, and engineering projects of ${siteConfig.author}, documented in this high-fidelity workspace.`;
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-start">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight sm:text-6xl amoriaregular">
                {siteConfig.author.split(' ')[0]}<span className="text-primary">{siteConfig.author.split(' ')[1] ? siteConfig.author.split(' ')[1][0] : ''}</span>
              </h1>
