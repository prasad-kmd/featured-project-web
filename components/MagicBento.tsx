...
const DEFAULT_GLOW_COLOR = "32, 178, 170"
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  const cardData: (BentoCardProps & { latest?: { title: string; description?: string } })[] = [
    ...
    },
    {
      ...
      title: "About",
      description: "Learn more about the project, our team, and our mission",
      href: "/about",
    },
    {
      ...
      href: "https://github.com/your-github/DMX4102-webapp-NEXTJS",
    },
    {
      icon: <Images className="h-6 w-6 text-primary" />,
      title: "Gallery",
      description: "View the gallery of the project",
      href: "/gallery",
    },
    {
      icon: <Users className="h-6 w-6 text-primary" />,
      title: "Team",
      description: "Team Members of this project",
      href: "/team",
    },
  ]
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card group flex flex-col justify-between relative aspect-auto min-h-[200px] w-full max-w-full p-5 rounded-xl border border-border bg-card transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 ${enableBorderGlow ? "card--border-glow" : ""
              }`
